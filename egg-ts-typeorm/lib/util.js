...
exports.getConnectionOptions = function (t) {
  ...
  return o.map(i => {
    ...
    return s.logger = s.logger || new r.default(t, s.logging), s.entitiesdir && (s.entities = [e.join(s.entitiesdir, "**", "local" === n.env ? "*.ts" : "*.js")]), s
  });
  var u
}, exports.getYamlConfig = i, exports.ucFirst = s, exports.getModelName = function (e, t) {
  e = e.replace(/\\/gi, "/"), t && 0 === e.indexOf(t) && "/" === (e = e.substr(t.length))[0] && (e = e.substr(1));
  const n = e.split("/"),
